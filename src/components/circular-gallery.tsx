...
class AppCore {
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: 'https://picsum.photos/seed/11/800/600', text: 'Brand Identity' },
      { image: 'https://picsum.photos/seed/22/800/600', text: 'Social Media' },
      { image: 'https://picsum.photos/seed/33/800/600', text: 'Ad Creatives' },
      { image: 'https://picsum.photos/seed/44/800/600', text: 'UI Design' },
      { image: 'https://picsum.photos/seed/55/800/600', text: 'Print Design' },
      { image: 'https://picsum.photos/seed/66/800/600', text: 'Logo Design' },
      { image: 'https://picsum.photos/seed/77/800/600', text: 'Packaging' },
      { image: 'https://picsum.photos/seed/88/800/600', text: 'Motion Graphics' },
    ];
...
export function CircularGallery({
  ...
  useEffect(() => {
    ...
    // Check WebGL support before initialising
